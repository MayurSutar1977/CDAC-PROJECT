    ...
    return (
        <div>
            ...
            <nav className="navbar navbar-expand-lg navbar-mainbg ">
...

                {
                    st === true && (<Dropdown>
                        ...
                        <Dropdown.Menu className="super-colors">
                            <Dropdown.Item  href="/view_profile"><i class="fas fa-id-card"></i> Profile </Dropdown.Item>
                            <Dropdown.Item href="/update-profile"><i class="fas fa-user-edit"></i> Update Profile </Dropdown.Item>
                ...
                <div
                    ...
                    <ul className="navbar-nav ml-auto">
                        ...
                        <li className="nav-item">
                            <Link className="nav-link text-light" to="/about_us" exact>
                                <i class="fas fa-address-book"></i>About
                             </Link>
                        </li>

                        <li className="nav-item">
                            <Link className="nav-link text-light" to="/all-equpment-to-sold" exact>
                                <i class="fab fa-product-hunt"></i>Equipments
                            </Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link text-light" to="/contact_us" exact>
                                <i className="far fa-copy"></i>Contact Us
                            </Link>
                        </li>
                        {/*window.localStorage.getItem("status") === true &&*/}
                        <li className="nav-item">
                            <Link className="nav-link text-light" to="/rent-line" >
                        ...
                        {st !== true &&
                            <li className="nav-item">
                                <Link className="nav-link text-light" to="/sign_in" >
                        ...
                        {st !== true &&
                            <li className="nav-item ">
                                <Link className="nav-link text-light" to="/sign_up" >
                        ...
                        {st === true &&
                            <li className="nav-item" >
                                <Link className="nav-link text-light" to="/sign-out" exact>
                        ...
                        {st === true &&
                            <li className="nav-item " >
                                <Link className="nav-link text-light" to="/view_profile" >
            ...
            <div className="d-flex flex-row flex-grow-0 flex-fill justify-content-center bg-info py-2 text-white px-0 news">
                <Marquee className="news-scroll" style={{ direction: "left", scrollamount: "30" }}><h5>Welcome to Rental System For Photography Accessories </h5></Marquee>
            </div>
        </div>
    );
}
