...
class componentName extends Component {
    ...
    componentDidMount() {
        ...
        EquipmentService.getAllEquipmentsByCatId(this.state.catId).then((res) => {
                                                    ...
                                                    this.state.equipments.map(
                                                        products =>
                                                            <tr key={products.id}>
                                                                ...
                                                                <td>
                                                                    <button className="btn btn-primary" onClick={() => this.editOldEquipment(products.id)} >Update</button>
                                                                    <button className="btn btn-info ml-2" onClick={() => this.viewOldEquipment(products.id)} >View</button>
                                                                    <button className="btn btn-danger ml-2" onClick={() => this.deleteOldEquipment(products.id)} >Delete</button>
                                                                </td>
